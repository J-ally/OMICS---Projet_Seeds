...
p<-ggplot(data=Frequencies[Frequencies$frequency>=0.99,],
...
ggplot(ordered_no_whitening, aes(x=index, y = frequency)) + 
geom_line()
```
```{r}
res.no_whitening = subset(Frequencies, frequency>=0.99)
```
...
p<-ggplot(data=Freq_np[Freq_np$frequency>=0.99,],
          aes(x=Names_of_Y,y=Names_of_X,color=Names_of_X))+
  geom_point(size=1)+theme(axis.text.x = element_text(angle = 90, size=5))+ylab('Levels of X')+xlab('m/z')
p
```
...
p<-ggplot(data=Freq_arma[Freq_arma$frequency>=0.99,],
          aes(x=Names_of_Y,y=Names_of_X,color=Names_of_X))+
  geom_point(size=1)+theme(axis.text.x = element_text(angle = 90, size=5))+ylab('Levels of X')+xlab('m/z')
p
```
...
p<-ggplot(data=Freq_ar[Freq_ar$frequency>=0.99,],
          aes(x=Names_of_Y,y=Names_of_X,color=Names_of_X))+
  geom_point(size=1)+theme(axis.text.x = element_text(angle = 90, size=5))+ylab('Levels of X')+xlab('m/z')
p
```
