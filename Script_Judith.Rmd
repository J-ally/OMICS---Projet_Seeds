...
Freq_np=variable_selection(Y,X,np_square_root_inv_hat_Sigma,nb_repli=5000,parallel=FALSE)
...
p<-ggplot(data=Freq_np[Freq_np$frequency>=0.95,],
          aes(x=Names_of_Y,y=Names_of_X,fill=frequency))+
  geom_tile(size=0.75)+scale_color_gradient2(midpoint=0.95,mid ='orange')+ theme(axis.text.x = element_text(angle = 90, size=5))+ylab('Levels of X')+xlab('m/z')
p

#To avoid false postive we only consider the variables that are always selected (with a frequency equal to one)

p<-ggplot(data=Freq_np[Freq_np$frequency==1,],
...
Freq_arma=variable_selection(Y,X,arma_square_root_inv_hat_Sigma,nb_repli=5000,parallel=FALSE)
```
...
p<-ggplot(data=Freq_arma[Freq_arma$frequency>=0.95,],
          aes(x=Names_of_Y,y=Names_of_X,fill=frequency))+
  geom_tile(size=0.75)+scale_color_gradient2(midpoint=0.95,mid ='orange')+ theme(axis.text.x = element_text(angle = 90, size=5))+ylab('Levels of X')+xlab('m/z')
p
...
p<-ggplot(data=Freq_arma[Freq_arma$frequency==1,],
          aes(x=Names_of_Y,y=Names_of_X,color=Names_of_X))+
  geom_point(size=1)+theme(axis.text.x = element_text(angle = 90, size=5))+ylab('Levels of X')+xlab('m/z')
p
```
...
Freq_ar=variable_selection(Y,X,ar_square_root_inv_hat_Sigma,nb_repli=5000,parallel=FALSE)
```
...
p<-ggplot(data=Freq_ar[Freq_ar$frequency>=0.95,],
          aes(x=Names_of_Y,y=Names_of_X,fill=frequency))+
  geom_tile(size=0.75)+scale_color_gradient2(midpoint=0.95,mid ='orange')+ theme(axis.text.x = element_text(angle = 90, size=5))+ylab('Levels of X')+xlab('m/z')
p
...
p<-ggplot(data=Freq_ar[Freq_ar$frequency==1,],
          aes(x=Names_of_Y,y=Names_of_X,color=Names_of_X))+
  geom_point(size=1)+theme(axis.text.x = element_text(angle = 90, size=5))+ylab('Levels of X')+xlab('m/z')
p
```
